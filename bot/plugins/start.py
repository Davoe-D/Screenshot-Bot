        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('🔖  Projects Channel', url='https://t.me/naijabestz')
                ],
                [
                    InlineKeyboardButton('💡  Website', url='https://www.9jabestz.com'),
                    InlineKeyboardButton('👨  Master', url='https://t.me/BestzBrothers')
                ]
            ]
        )
    )
